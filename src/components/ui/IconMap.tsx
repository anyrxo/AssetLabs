/**
 * SVG icon set for services & values.
 * Keeps bundle tiny — no lucide-react dependency.
 */
...
const icons: Record<string, React.FC<{ className?: string }>> = {
  ...
  HardHat: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v2z" /><path d="M10 15V6a2 2 0 0 1 4 0v9" /><path d="M4 15v-3a8 8 0 0 1 16 0v3" />
    </svg>
  ),
  Briefcase: ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export const Icon = ({ name, className = "h-6 w-6" }: { name: string; className?: string }) => {
